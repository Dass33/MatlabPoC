...
A missing probe file is a safe state: the watchdog treats repeated fetch
failures as "no job running" and disconnects, which is correct on a fresh
container where no script (and therefore no job) has ever run.
